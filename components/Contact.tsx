...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setStatus({ type: 'success', message: 'Message sent! Sagor will contact you shortly.' });
    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-3 gap-10 mb-20">
        {[
          ...
          { icon: '📱', title: 'WhatsApp', value: '+880 1959-289905' },
          { icon: '📧', title: 'Email', value: 'bdsagordm@gmail.com' }
        ].map((item, i) => (
